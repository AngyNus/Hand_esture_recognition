...
%sets videoinput to the webcam, and the webcam device 1
    ...
    pause(0.1);                                                                 % pause 2 seconds before snapshot of background image
    ...
    pause(0.2);                                                                 %pause a second before taking the test image snapshot
    ...
    IM3 = bwareaopen(IM3, 50000);                                               %finds objects, noise or regions with pixel area lower than 10,000 and removes them
    ...
    %calculate the properties of regions for objects found
        ...
        if RND >0.4 && RND < 0.8 && pkNo > 2
            CHAR_STR = 'W';
        elseif RND >0.02 && RND < 0.4  && pkNo ==1
            CHAR_STR = 'I';
        elseif RND >0.6 && RND < 0.99 && pkNo == 1
            CHAR_STR = 'O';
        elseif RND >0.20 && RND < 0.99 && pkNo == 2
            CHAR_STR = 'V';
        else
